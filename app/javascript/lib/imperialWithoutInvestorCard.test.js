...
const log = [
  ...
  Action.bondPurchase({ player: "player2", cost: 4, nation: Nation.GB, tradeInValue: 0 }),
  Action.bondPurchase({ player: "player1", cost: 2, nation: Nation.GB, tradeInValue: 0 }),
  ...
  Action.bondPurchase({ player: "player2", cost: 4, nation: Nation.RU, tradeInValue: 0 }),
  Action.bondPurchase({ player: "player1", cost: 2, nation: Nation.RU, tradeInValue: 0 }),
]
...
describe("round of investment", () => {
  test("each player can invest in one country", () => {
    ...
    game.tick(Action.bondPurchase({ nation: Nation.AH, cost: 6, player: "player1", tradeInValue: 0 }))
  ...
  test("it auto-skips a player who cannot afford to invest", () => {
    ...
    game.tick(Action.rondel({ nation: Nation.AH, cost: 0, slot: "investor" }))
    game.tick(Action.bondPurchase({ nation: Nation.AH, cost: 25, player: "player1", tradeInValue: 4 }))
    game.tick(Action.bondPurchase({ nation: Nation.AH, cost: 20, player: "player2", tradeInValue: 0 }))
    game.tick(Action.rondel({ nation: Nation.IT, cost: 0, slot: "investor" }))
    game.tick(Action.bondPurchase({ nation: Nation.IT, cost: 9, player: "player2", tradeInValue: 4 }))
    game.tick(Action.bondPurchase({ nation: Nation.IT, cost: 6, player: "player1", tradeInValue: 2 }))
    game.tick(Action.rondel({ nation: Nation.FR, cost: 0, slot: "investor" }))
    game.tick(Action.bondPurchase({ nation: Nation.FR, cost: 6, player: "player1", tradeInValue: 4 }))
  ...
  test("a more elaborate auto-skipping example", () => {
    const log = [
      ...
      Action.bondPurchase({ player: "player1", cost: 6, nation: Nation.AH, tradeInValue: 0 }),
      Action.bondPurchase({ player: "player2", cost: 4, nation: Nation.AH, tradeInValue: 0 }),
      Action.bondPurchase({ player: "player3", cost: 2, nation: Nation.AH, tradeInValue: 0 }),
      Action.bondPurchase({ player: "player2", cost: 6, nation: Nation.IT, tradeInValue: 0 }),
      Action.bondPurchase({ player: "player3", cost: 4, nation: Nation.IT, tradeInValue: 0 }),
      Action.bondPurchase({ player: "player1", cost: 2, nation: Nation.IT, tradeInValue: 0 }),
      Action.bondPurchase({ player: "player3", cost: 6, nation: Nation.FR, tradeInValue: 0 }),
      Action.bondPurchase({ player: "player1", cost: 4, nation: Nation.FR, tradeInValue: 0 }),
      Action.bondPurchase({ player: "player2", cost: 2, nation: Nation.FR, tradeInValue: 0 }),
      Action.bondPurchase({ player: "player1", cost: 6, nation: Nation.GB, tradeInValue: 0 }),
      Action.bondPurchase({ player: "player2", cost: 4, nation: Nation.GB, tradeInValue: 0 }),
      Action.bondPurchase({ player: "player3", cost: 2, nation: Nation.GB, tradeInValue: 0 }),
      Action.bondPurchase({ player: "player2", cost: 6, nation: Nation.GE, tradeInValue: 0 }),
      Action.bondPurchase({ player: "player3", cost: 4, nation: Nation.GE, tradeInValue: 0 }),
      Action.bondPurchase({ player: "player1", cost: 2, nation: Nation.GE, tradeInValue: 0 }),
      Action.bondPurchase({ player: "player3", cost: 6, nation: Nation.RU, tradeInValue: 0 }),
    ...
    game.tick(Action.rondel({ nation: Nation.IT, cost: 0, slot: "investor" }))
    game.tick(Action.bondPurchase({ player: "player2", cost: 9, nation: Nation.IT, tradeInValue: 0 }))
    game.tick(Action.rondel({ nation: Nation.FR, cost: 0, slot: "investor" }))
    game.tick(Action.bondPurchase({ player: "player3", cost: 9, nation: Nation.FR, tradeInValue: 0 }))
