...
export default {
  ...
  data() {
    return {
      sea_provinces: {
        "Caribbean Sea": markRaw(caribbean_sea),
        "Caspian Sea": markRaw(caspian_sea),
        "Gulf of Guinea": markRaw(gulf_of_guinea),
        "Indian Ocean": markRaw(indian_ocean),
        "Mediterranean Sea": markRaw(mediterranean_sea),
        "Black Sea": markRaw(black_sea),
        "North Atlantic": markRaw(north_atlantic),
        "North Pacific": markRaw(north_pacific),
        "Sea of Japan": markRaw(sea_of_japan),
        "South Atlantic": markRaw(south_atlantic),
        "South Pacific": markRaw(south_pacific),
        "Tasman Sea": markRaw(tasman_sea),
        "China Sea": markRaw(china_sea)
      },
      land_provinces: {
        ...
        "Congo": markRaw(congo),
        "East Africa": markRaw(east_africa),
        ...
        "Near East": markRaw(near_east),
        "New Delhi": markRaw(new_delhi),
        "New Orleans": markRaw(new_orleans),
        "New York": markRaw(new_york),
        "New Zealand": markRaw(new_zealand),
        "Nigeria": markRaw(nigeria),
        "North Africa": markRaw(north_africa),
        "Novosibirsk": markRaw(novosibirsk),
        "Chicago": markRaw(chicago),
        "Paris": markRaw(paris),
        "Quebec": markRaw(quebec),
        "Rio de Janeiro": markRaw(rio_de_janeiro),
        "Rome": markRaw(rome),
        "San Francisco": markRaw(san_francisco),
        "Shanghai": markRaw(shanghai),
        "South Africa": markRaw(south_africa),
