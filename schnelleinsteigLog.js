...
export default [
  ...
  Action.noop, // Action.assignStartingNation({ nation: Nation.RU, player: "Daniel" }),
  Action.noop, // Action.assignStartingNation({ nation: Nation.FR, player: "Claudia" }),
  Action.noop, // Action.assignStartingNation({ nation: Nation.GB, player: "Bert" }),
  Action.noop, // Action.assignStartingNation({ nation: Nation.IT, player: "Anton" }),
  Action.noop, // Action.bondPurchase({ nation: Nation.AH, player: "Claudia", cost: 2 }),
  Action.noop, // Action.bondPurchase({ nation: Nation.IT, player: "Anton", cost: 9 }),
  Action.noop, // Action.bondPurchase({ nation: Nation.FR, player: "Claudia", cost: 9 }),
  Action.noop, // Action.bondPurchase({ nation: Nation.FR, player: "Daniel", cost: 2 }),
  Action.noop, // Action.bondPurchase({ nation: Nation.GB, player: "Anton", cost: 2 }),
  Action.noop, // Action.bondPurchase({ nation: Nation.GB, player: "Bert", cost: 9 }),
  Action.noop, // Action.bondPurchase({ nation: Nation.RU, player: "Bert", cost: 2 }),
  Action.noop, // Action.bondPurchase({ nation: Nation.RU, player: "Daniel", cost: 9 }),
  Action.noop, // Action.startFirstRound(),
  // first round
